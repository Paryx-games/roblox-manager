...
2. Add a `## vX.Y.Z` entry to `CHANGELOG.md` for the new version, above the previous entry. The release workflow reads this section directly and fails the release if it can't find a heading matching the tag.
