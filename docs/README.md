---
description: Manage Roblox accounts and sessions from one Windows app.
icon: house-chimney
---

# Home

## Welcome to Roblox Manager

Roblox Manager keeps your Roblox sessions in one place. Manage accounts, launch games, and run multiple instances from one Windows app.
